@if ($data->count() > 0)
    ...
    <div class="panel panel-default">
        <div class="panel-head">
            ...
            <h5 style="margin-left: 10px; color: rgb(255, 153, 0)"><b><i class="far fa-clock"></i> MENUNGGU PENGIRIMAN</b></h5>
        </div>
        <div class="col-xs-12">
            ...
            <div class="col-xs-12 col-md-4">
                <div class="pesanan-harga">
                    ...
                    <div style="margin-top: 40px">
                        <button onclick="antar({{$d->id}})" class="btn btn-warning">Antar Sekarang</button>
                    </div>
                </div>
            </div>
        </div>
